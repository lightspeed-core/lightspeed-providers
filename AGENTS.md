...
└── providers
    ├── inline
    │   ├── agents
    │   │   └── lightspeed_inline_agent        # Lightspeed inline agent provider
    │   │       └── responses
    │   └── safety
    │       ├── lightspeed_question_validity   # Question validity provider
    │       └── lightspeed_redaction           # Redaction provider
    │           └── lightspeed_redaction
    └── remote
        └── solr_vector_io
            └── solr_vector_io                 # SOLR vector IO provider
                └── src
                    └── solr_vector_io
```
