...
from lightspeed_stack_providers.providers.remote.solr_vector_io.solr_vector_io.src.solr_vector_io.filter_helpers import (
    build_solr_filter_query,
    filter_to_solr_fq,
)

# pylint: enable=line-too-long

# Maintain backward compatibility with test function names
_filter_to_solr_fq = filter_to_solr_fq
...
class TestCompoundFilters:
    ...
    def test_and_filter(self) -> None:
        ...
        result = _filter_to_solr_fq(filter_obj)
        assert result == '(product:"openshift_container_platform" AND version:"4.21")'
    ...
    def test_or_filter(self) -> None:
        ...
        assert (
            result
            == '(product:"openshift_container_platform" OR product:"ansible_automation_platform")'
        )
